...
public abstract class agreeAddFriendRequest implements Server.Callback {
    @Override
    public void run(Message msg, boolean result) {
        if (result && msg.what == Message.WHAT_AGREE_ADD_FRIEND_REQUEST_RESULT && msg.booleans != null && msg.booleans.length > 0) {
